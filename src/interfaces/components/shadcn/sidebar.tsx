...
import { Input } from "@/interfaces/components/shadcn/input";
...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@/interfaces/components/shadcn/sheet";
import { Skeleton } from "@/interfaces/components/shadcn/skeleton";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
  TooltipTrigger,
} from "@/interfaces/components/shadcn/tooltip";
import { NAVBAR_HEIGHT } from "@/interfaces/styles/constants";
    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "relative flex h-max w-full flex-col",
