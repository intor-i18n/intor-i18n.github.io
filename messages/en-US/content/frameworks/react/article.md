...
This page demonstrates the minimal integration flow of Intor in a React project.
...
Intor can be used in any React project and does not depend on a specific build tool.  
In this example, we use Vite to set up the React project. See: [Vite Documentation](https://vite.dev/guide/#scaffolding-your-first-vite-project)
...
Create a shared config file `intorConfig` to define Intor’s core behavior.  
...
Use `IntorProvider` during application startup to inject config and locale.  
