...
本頁示範 Intor 在 Vite + React 專案中的最小整合流程。
...
請依照官方指引建立 Vite + React 專案：[Vite 官方文件](https://vite.dev/guide/#scaffolding-your-first-vite-project)
...
此範例使用最簡單的方式，直接匯入語言檔作為 `messages` 來源。
